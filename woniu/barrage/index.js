let data = [
    { value: '测试测试测试测试测试测试测试测试', time: 5, color: 'red', speed: '1', fontSize: 22 },
    { value: '听妈妈的话听妈妈的话听妈妈的话', time: 5, color: 'red', speed: '1', fontSize: 22 },
    { value: '大爱', time: 31 },
    { value: '周杰伦周杰伦周杰伦周杰伦', time: 18, color: 'red', speed: '1', fontSize: 22 },
    { value: '听妈妈的话吧，晚点再恋爱吧！爱呢？', time: 10, color: 'red', speed: '1', fontSize: 22 },
    { value: '测试测试测试测试测试测试测试测试', time: 30, color: 'red', speed: '1', fontSize: 22 },
    { value: '测试测试测试测试测试测试测试测试', time: 51, color: 'red', speed: '1', fontSize: 22 },
    { value: '测试测试测试测试测试测试测试测试', time: 40, color: 'red', speed: '1', fontSize: 22 },
    { value: '测试测试测试测试测试测试测试测试', time: 7, color: 'red', speed: '1', fontSize: 22 },
];
...
//设置 video 的 play 事件来调用 CanvasBarrage 实例的 render 方法
